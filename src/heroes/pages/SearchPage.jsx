        ...
        <div className="row">
          <div className="col-5">
            ...
            <div className="col-7">
              ...
              <div aria-label="alert-danger" className="alert alert-danger animate__animated animate__fadeIn" style={{display: showError?'':'none'}}>There's not a hero with <b>{q}</b></div>
